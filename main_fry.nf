...
// run alevin-fry for quantification with splici index
 process alevin_fry_MR3 {
    ...
    then
        alevin-fry generate-permit-list --input ${runId}_ALEVIN_fry_map -d fw --unfiltered-pl /nfs/production/irene/ma/users/nnolte/whitelist/13M-february-2018_onecollum.txt    --output-dir ${runId}_ALEVIN_fry_quant --min-reads 10
    else
